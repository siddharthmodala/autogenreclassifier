...
def feature_extractor(synopsis_files):
    ...
    feature_list = '..\..\Data\\knn8featureset\\feature_list.p'
    ...
    feature_dict = '..\..\Data\\knn8featureset\\feature_dict.p'
...
def feature_data_set(synopsis_files,genre_set,feature_set_files,list_type):
    ...
    #return ["..\..\Data\\knn8featureset\test_data_set.p","..\..\Data\\knn8featureset\test_genre_set.p"]
...
if __name__ == '__main__':
    ...
    feature_set_files = ['..\..\Data\\knn8featureset\\feature_dict.p','..\..\Data\\knn8featureset\\feature_list.p',]
    feature_set_files = feature_extractor(synopsis_files)


    data_set_file = ["..\..\Data\\knn8featureset\data_set.p",
                     "..\..\Data\\knn8featureset\genre_set.p",
                     "..\..\Data\\knn8featureset\moviename_set.p"]

    data_set_file = feature_data_set(synopsis_files, genre_set, feature_set_files,False)

    test_set_file = ["..\..\Data\\knn8featureset\\test_data_set.p",
                     "..\..\Data\\knn8featureset\\test_genre_set.p",
                     "..\..\Data\\knn8featureset\\test_moviename_set.p"]
    ...
    for k in test_genre_set:
        if all([x == 0 for x in k ]):
            print k

    lb= LabelBinarizer()
    knn_clf = neighbors.KNeighborsClassifier(n_neighbors=6,algorithm='ball_tree',weights='distance')
    ...
    #test_genre_set = np.array([x for x in test_genre_set])
    #print knn_clf.score(test_data_set,test_genre_set)

    test_genre_set = lb.transform(test_genre_set)
    for i in [3,6,9,12,15,18,21,24,27,30]:
        for j in ['ball_tree','kd_tree']:
