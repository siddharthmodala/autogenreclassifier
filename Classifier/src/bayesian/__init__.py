...
def feature_extractor(synopsis_files):
    ...
    filtered_stem_words = [(w,count) for w,count in stem_words_freq.items() if count > 8]

    feature_list = '..\..\Data\\featureset\\feature_list.p'
    ...
    feature_dict = '..\..\Data\\featureset\\feature_dict.p'
...
if __name__ == '__main__':
    ...
    feature_set_files = ['..\..\Data\\featureset\\feature_dict.p','..\..\Data\\featureset\\feature_list.p']
